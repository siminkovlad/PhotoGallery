...
export const POST_COMMENTS = 'photo-gallery/src/redux/postComment/POST_COMMENTS';
export const SEND_COMMENTS = 'photo-gallery/src/redux/postComment/SEND_COMMENTS';
